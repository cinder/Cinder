...
class VideoCubesApp : public App 
{
...
void prepareSettings( VideoCubesApp::Settings* settings )
{
	settings->setMultiTouchEnabled( false );
}

void VideoCubesApp::setup()
{
...
CINDER_APP( VideoCubesApp, RendererGl, prepareSettings )
