...
void CameraPerspApp::setup()
{
	...
	try {
		mCubeMap = gl::TextureCubeMap::create( loadImage( loadAsset( "env_map.png" ) ), gl::TextureCubeMap::Format().mipmap() );
...
CINDER_APP( CameraPerspApp, RendererGl( RendererGl::Options().msaa( 16 ) ) )
