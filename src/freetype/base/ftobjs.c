...
#define FT_MD5_u32plus  FT_FT_MD5_u32plus
#define FT_MD5_CTX      FT_FT_MD5_CTX
#define FT_MD5_Init     FT_FT_MD5_Init
#define FT_MD5_Update   FT_FT_MD5_Update
#define FT_MD5_Final    FT_FT_MD5_Final
