...
function( ci_make_app )
	...
	foreach( block ${ARG_BLOCKS} )
		...
		elseif( EXISTS ${ARG_CINDER_PATH}/blocks/${block}/proj/cmake )
			...
			set( blockName "${block}" )
		elseif( EXISTS ${ARG_CINDER_PATH}/blocks/Cinder-${block}/proj/cmake )
			get_filename_component( blockModuleDir "${ARG_CINDER_PATH}/blocks/Cinder-${block}/proj/cmake" ABSOLUTE )
			set( blockName "${block}" )
