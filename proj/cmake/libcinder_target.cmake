...
if( CINDER_MSW )
    ...
    message("-- DEBUG STATIC_LIBS_FLAGS: ${CINDER_STATIC_LIBS_FLAGS_DEBUG} ${CINDER_STATIC_LIBS_DEPENDS_DEBUG}" )
    message("-- STATIC_LIBS_FLAGS: ${CINDER_STATIC_LIBS_FLAGS_RELEASE} ${CINDER_STATIC_LIBS_DEPENDS_RELEASE}" )
