...
CI_API extern PFNGLDRAWARRAYSINSTANCEDPROC _funcptr_glDrawArraysInstanced;
#define glDrawArraysInstanced _funcptr_glDrawArraysInstanced
CI_API extern PFNGLDRAWELEMENTSINSTANCEDPROC _funcptr_glDrawElementsInstanced;
...
CI_API extern PFNGLPRIMITIVERESTARTINDEXPROC _funcptr_glPrimitiveRestartIndex;
#define glPrimitiveRestartIndex _funcptr_glPrimitiveRestartIndex
CI_API extern PFNGLTEXBUFFERPROC _funcptr_glTexBuffer;
