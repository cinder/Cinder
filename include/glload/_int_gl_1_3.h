...
CI_API extern PFNGLACTIVETEXTUREPROC _funcptr_glActiveTexture;
#define glActiveTexture _funcptr_glActiveTexture
CI_API extern PFNGLCOMPRESSEDTEXIMAGE1DPROC _funcptr_glCompressedTexImage1D;
#define glCompressedTexImage1D _funcptr_glCompressedTexImage1D
CI_API extern PFNGLCOMPRESSEDTEXIMAGE2DPROC _funcptr_glCompressedTexImage2D;
#define glCompressedTexImage2D _funcptr_glCompressedTexImage2D
CI_API extern PFNGLCOMPRESSEDTEXIMAGE3DPROC _funcptr_glCompressedTexImage3D;
#define glCompressedTexImage3D _funcptr_glCompressedTexImage3D
CI_API extern PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC _funcptr_glCompressedTexSubImage1D;
#define glCompressedTexSubImage1D _funcptr_glCompressedTexSubImage1D
CI_API extern PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC _funcptr_glCompressedTexSubImage2D;
#define glCompressedTexSubImage2D _funcptr_glCompressedTexSubImage2D
CI_API extern PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC _funcptr_glCompressedTexSubImage3D;
#define glCompressedTexSubImage3D _funcptr_glCompressedTexSubImage3D
CI_API extern PFNGLGETCOMPRESSEDTEXIMAGEPROC _funcptr_glGetCompressedTexImage;
#define glGetCompressedTexImage _funcptr_glGetCompressedTexImage
CI_API extern PFNGLSAMPLECOVERAGEPROC _funcptr_glSampleCoverage;
